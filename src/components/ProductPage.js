...
export default function ProductPage() {
  ...
  function getProduct() {
    ...
    const request = axios.get(
      `${process.env.REACT_APP_API_BASE_URL}/product/${params.id}`,
      config
    );
    ...
    <Container>
      ...
      <Wrapper>
        ...
        <Info>
          ...
          <div className="quantity-available-items">
            {product.availableQuantity} itens disponíveis
          </div>
          <AddToCart onClick={(e) => addToCart(e)}>
            {" "}
